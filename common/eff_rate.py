...
def compute_deepTau_rate(taus, Nev_den, deepTau_thr, Pt_thr=20, L1rate=75817.94, is_MC=False, xs=469700.0):
    """
...
def compute_deepTau_rate_list(taus, Nev_den, thr_list, Pt_thr=20, is_MC=False, L1rate=75817.94, xs=469700.0):
    '''
    ...
    err_list_up = []
    for thr in thr_list:
        rate_results = compute_deepTau_rate(taus, Nev_den, thr, Pt_thr=Pt_thr, is_MC=is_MC, L1rate=L1rate, xs=xs)
...
def compute_isocut_rate(taus, Nev_den, var_abs, var_rel, Pt_thr=20, is_MC=False, L1rate=75817.94, xs=469700.0):
    """
