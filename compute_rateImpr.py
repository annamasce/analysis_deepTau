...
for n, Pt_thr in enumerate(Pt_thr_list):
    ...
    def f(thr):
        eff, _, _ = compute_deepTau_eff_diTau(taus[0], taus[1], gen_taus[0], gen_taus[1], thr, Pt_thr=Pt_thr)
        return eff - eff_base
    ...
    rate = compute_deepTau_rate_diTau(taus_rates[0], taus_rates[1], Nev_den, deep_thr, Pt_thr=Pt_thr)
